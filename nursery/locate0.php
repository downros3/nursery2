                                    ...
                                    <h4 class="panel-title">
                                        ...
                                        Search the plant:<br><br>
                                            ...
                                            <table border ="1" width="100%">
                                                <td>Name:<?php echo $nur_name; ?> <br><br> Address:<?php echo $nur_address; echo $nur_post; echo $nur_city; echo $nur_state; ?> <br><br> Operation Hour:<?php echo $nur_operation; ?> <br><br> Phone Number:<?php echo $nur_phone; ?> <br><br> Website: <a href=<?php echo $nur_web; ?></a>Click Here </td><br>
                                            </table>
                                        </form>
                                    </font> 
